...
signed schema 9 multi-architecture evidence in the same deployment bundle as the release manifest,
...
The schema-v3 composition also records the promoted ego-browser Bridge `0.1.7`
